<template>
  <div style="width: 100%">
    <many-chart ref="chart"
                :chartDatas="many_chart"
                :classes="classNames"
...
<script>
import ManyChart from '../../packages/ManyChart/src/ManyChart.vue'
import many_chart from '../assets/mock/manyChart.json'
export default {
  name: 'ManyChartTest',
  components: { ManyChart },
  data() {
    return {
      many_chart,
