...
<script>
import SearchFilterComp from "../../packages/SearchFilterComp/src/SearchFilterComp";

export default {
  name: "SchemeTableTest",
  components: {
    SearchFilterComp
  },
  data() {
